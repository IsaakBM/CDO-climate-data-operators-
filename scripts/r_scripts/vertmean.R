...
ipath <- "/QRISdata/Q1215/ClimateModels/CMIP6_rclean_regrid_layers/thetao_01deg/ssp126" # Input path
opath <- "/QRISdata/Q1215/ClimateModels/CMIP6_rclean_regrid_vertmean/thetao_01deg/ssp126/" # Output path
