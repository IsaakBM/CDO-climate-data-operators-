...
ipath <- "/QRISdata/Q1215/ClimateModels/CMIP6_rclean_regrid_vertmean/thetao_05deg/ssp585" # Input path
opath <- "/QRISdata/Q1215/ClimateModels/CMIP6_rclean_regrid_zmerge/thetao_05deg/ssp585/" # Output path
...
#ipath <- "/QRISdata/Q1215/ClimateModels/CMIP6_rclean_regrid_vertmean/ph_05deg/ssp126" # Input path
#opath <- "/QRISdata/Q1215/ClimateModels/CMIP6_rclean_regrid_zmerge/phd_05deg/ssp126/" # Output path
